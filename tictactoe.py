...
root = Tk()
root.title("Sahin's Game")
root.geometry("290x258")
button1 = Button(root, text=" ", command= lambda : activated(1))
button1.grid(row='0', column='0', ipadx='40', ipady='30')
button2 = Button(root, text=" ", command= lambda : activated(2))
button2.grid(row='0', column='1', ipadx='40', ipady='30')
button3 = Button(root, text=" ", command= lambda : activated(3))
button3.grid(row='0', column='2', ipadx='40', ipady='30')
button4 = Button(root, text=" ", command= lambda : activated(4))
button4.grid(row='1', column='0', ipadx='40', ipady='30')
button5 = Button(root, text=" ", command= lambda : activated(5))
button5.grid(row='1', column='1', ipadx='40', ipady='30')
button6 = Button(root, text=" ", command= lambda : activated(6))
button6.grid(row='1', column='2', ipadx='40', ipady='30')
button7 = Button(root, text=" ", command= lambda : activated(7))
button7.grid(row='2', column='0', ipadx='40', ipady='30')
button8 = Button(root, text=" ", command= lambda : activated(8))
button8.grid(row='2', column='1', ipadx='40', ipady='30')
button9 = Button(root, text=" ", command= lambda : activated(9))
...
def activated(box):
    ...
    if bx1 == bx5 == bx9 == "X" or bx3 == bx5 == bx7 == "X" :
        ...
        exit()
    if cnt == 9:
        messagebox.showinfo("Game end", " Match Draw ")
        exit()
